...
export default function HomePage({ tracks, onPlay, setPage, player }: Props) {
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="relative z-10 p-8 flex items-end gap-6 w-full">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button onClick={() => setPage("upload")} className="glass-card px-6 py-2.5 rounded-xl text-white/80 hover:text-white text-sm font-display tracking-wider flex items-center gap-2 transition-colors border border-white/20">
      ...
      <section className="grid grid-cols-3 gap-4 mb-12">
        {[
          ...
          { icon: "Upload", label: "Загрузок", val: "Батч 100" },
        ].map(s => (
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={() => setPage("player")} className="text-white/40 hover:text-white text-sm flex items-center gap-1 transition-colors">
